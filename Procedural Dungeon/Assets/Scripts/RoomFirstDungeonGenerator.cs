...
public class RoomFirstDungeonGenerator : RandomWalkGenerator
{
    ...
    {
        var roomsList = ProceduralAlgorithms.BinarySpacePartitioning(new BoundsInt((Vector3Int)startPosition, new Vector3Int
        ...
        tileMapGraphics.PaintFloorTiles(floor);
        WallGenerator.CreateWalls(floor, tileMapGraphics);
    }

    private HashSet<Vector2Int> RandomlyCreateRooms(List<BoundsInt> roomsList)
    {
        HashSet<Vector2Int> floor = new HashSet<Vector2Int>();
